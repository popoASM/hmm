...
struct csiphy_reg_t csiphy_2ph_v2_1_3_reg_m16t[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0094, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x00A0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0090, 0x0f, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0030, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0028, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0000, 0x92, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x000C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0038, 0xFE, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x002C, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0034, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0020, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0008, 0x10, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0010, 0x62, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0094, 0xD7, 0x00, CSIPHY_SKEW_CAL},
		{0x005C, 0x04, 0x00, CSIPHY_SKEW_CAL},
		{0x0060, 0xBD, 0x00, CSIPHY_SKEW_CAL},
		{0x0064, 0x7F, 0x00, CSIPHY_SKEW_CAL},
	},
	{
		...
		{0x0E20, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0E08, 0x10, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0E10, 0x62, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0E94, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x0E5C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0E60, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0E64, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		...
		{0x0430, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0428, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0400, 0x92, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x040C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0438, 0xFE, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x042C, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0434, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0420, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0408, 0x10, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0410, 0x62, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0494, 0xD7, 0x00, CSIPHY_SKEW_CAL},
		{0x045C, 0x04, 0x00, CSIPHY_SKEW_CAL},
		{0x0460, 0xBD, 0x00, CSIPHY_SKEW_CAL},
		{0x0464, 0x7F, 0x00, CSIPHY_SKEW_CAL},
	},
	{
		...
		{0x0830, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0828, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0800, 0x92, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x080C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0838, 0xFE, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x082C, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0834, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0820, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0808, 0x10, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0810, 0x62, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0894, 0xD7, 0x00, CSIPHY_SKEW_CAL},
		{0x085C, 0x04, 0x00, CSIPHY_SKEW_CAL},
		{0x0860, 0xBD, 0x00, CSIPHY_SKEW_CAL},
		{0x0864, 0x7F, 0x00, CSIPHY_SKEW_CAL},
	},
	{
		...
		{0x0C30, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C28, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0C00, 0x92, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C0C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0C38, 0xFE, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C2C, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C34, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0C20, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C08, 0x10, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0C10, 0x62, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C94, 0xD7, 0x00, CSIPHY_SKEW_CAL},
		{0x0C5C, 0x04, 0x00, CSIPHY_SKEW_CAL},
		{0x0C60, 0xBD, 0x00, CSIPHY_SKEW_CAL},
		{0x0C64, 0x7F, 0x00, CSIPHY_SKEW_CAL},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0278, 0x45, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0288, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0xd8, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x026C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0214, 0x09, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x108C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0678, 0x45, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0688, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0xd8, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x066C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0614, 0x09, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x108C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A78, 0x45, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A88, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0xd8, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A6C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A14, 0x09, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x108C, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t csiphy_2ph_v2_1_3_reg_m11a[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0094, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x00A0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0090, 0x0f, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct data_rate_settings_t data_rate_delta_table_2_1_3_xiaomi_m16t = {
	.num_data_rate_settings = 26,
	.data_rate_settings = {
		{
			/* ((100 MSpS) * (10^6) * (2.28 bits/symbol)) rounded value*/
		...
		{
			/* ((1.7 GSpS) * (10^9) * (2.28 bits/symbol)) rounded value*/
			.this_setting_max_choice = 2,
			.this_setting_current_choice = 0,
			.bandwidth = 3876000000,
			.data_rate_reg_array_size = 9,
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						{0x0270, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x3E, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0288, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0xF8, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x026C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						{0x0670, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x3E, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0688, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0xF8, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x066C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						{0x0A70, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x3E, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A88, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0xF8, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A6C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t csiphy_2ph_v2_1_3_reg_l3s[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0094, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x00A0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0090, 0x0f, 0x00, CSIPHY_DEFAULT_PARAMS},
